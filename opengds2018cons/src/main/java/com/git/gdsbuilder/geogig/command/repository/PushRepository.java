...
public class PushRepository {
	...
	public GeogigPush executeCommand(String baseURL, String username, String password,
			String repository, String remoteName, String branchName, String remoteBranchName) {
