 ...
 *
 */
public class CancleTransaction {

	private static final Log logger = LogFactory.getLog(CancleTransaction.class);

	private static final String command = "endTransaction";
	private static final String param_transactionId = "transactionId=";
	private static final String param_cancle = "cancle=true";
