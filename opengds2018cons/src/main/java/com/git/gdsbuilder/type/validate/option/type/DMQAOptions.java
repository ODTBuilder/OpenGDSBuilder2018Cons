...
public class DMQAOptions {
	...
	public enum Type {
		...
		SMALLAREA("SmallArea", "Areas under tolerance limit", "허용범위이하면적오류","GraphicError", "그래픽오류"), 
		SMALLLENGTH("SmallLength", "Segments under length tolerance limit", "허용범위이하길이오류","GraphicError", "그래픽오류"), 
		...
		ONEACRE("OneAcre", "Mismatching farmland", "지류계오류","GraphicError", "그래픽오류"), 
		ONESTAGE("OneStage", "Excluded farmland", "경지계오류","GraphicError", "그래픽오류"), 
		...
		SYMBOLOUT("SymbolOut", "Symbol misplacement (Underground)", "심볼단독존재오류","GraphicError", "그래픽오류"), 
		
		ZVALUEAMBIGUOUS("ZValueAmbiguous", "Elevation", "고도값오류","AttributeError", "속성오류"), 
		BRIDGENAME("BridgeName", "Bridge name", "교량명오류","AttributeError", "속성오류"), 
		...
		REFZVALUEMISS("RefZValueMiss", "Wrong elevation of adjacent same feature", "인접요소고도값오류","AdjacentError", "인접오류"); 
